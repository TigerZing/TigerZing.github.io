...
<!-- Tab links -->
<div class="tab">
  <button class="tablinks" onclick="openCity(event, 'english_ver')">English version</button>
  <button class="tablinks" onclick="openCity(event, 'japanese_ver')">Japanese version</button>
</div>
