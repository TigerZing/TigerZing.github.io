...
<div class="container">
  ...
  <table cellspacing="15" width="100%" style="margin-left: auto;  margin-right: auto; table-layout:fixed;">
    <tbody>
        <tr>
            <td width="40%" style="">
                <img src="/assets/images/hasnine_mohammad_nehal.jpeg">
            </td>
            <td>
              <span><a href="https://researchmap.jp/nehalhasnine"><b>HASNINE MOHAMMAD NEHAL (ハスナイン モハーマド ネハル)</b></a></span>
              <p>Associate Professor at the Research Center for Computing and Multimedia Studies of Hosei University.</p>
            </td>
        </tr>
    </tbody>
  </table>
