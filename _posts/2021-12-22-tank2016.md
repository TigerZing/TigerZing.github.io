...
title: "[ASSIGNMENT] Tank2016: Tank game 2016: Tank game with AI enemies "
description: EyeTeck.
comments: false
category: 
- portfolio
...
I applied A* Algorithm to make the bot more intelligent. 
<i class="fa fa-circle"></i> <span style="color:blue">Blue bot</span>: freedom to move and shoot bullets
<i class="fa fa-circle"></i> <span style="color:yellow">Yellow bot</span>: find a way to chase and attack player house
<i class="fa fa-circle"></i> <span style="color:red">Red bot</span>: find a way to attack the main house
<i class="fa fa-circle"></i> <span style="color:black">Fighter</span>: appear and drop bombs randomly
...
A* Algorithm,
<br>
<img src="/assets/images/tank_imgs/a_star.png" style="width:100px">
